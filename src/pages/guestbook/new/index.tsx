          ...
          <form className="w-full mt-10">
            <div className="w-full bg-base-200 min-h-[60px] rounded-t flex justify-between">
              <div className="h-[60px] flex items-end w-1/2 px-5">
                <div className="tabs">
                  <a className="tab tab-bordered tab-active">Write</a>
                  <a className="tab tab-bordered">Preview</a>
                </div>
              </div>
            ...
            <textarea name="content" id="guestbook" rows={30} className="bg-transparent rounded-b w-full h-[400px] border border-slate-700 p-3" placeholder="Type Here" value={content} onChange={(e) => setContent(e.target.value)}></textarea>
          </form>
        </section>
      </main>
      <Footer />
